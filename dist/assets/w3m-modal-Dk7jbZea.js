import{dV as k,ez as le,d9 as c,db as pe,dt as v,du as V,dx as f,dy as g,dz as d,dw as l,dL as $,dk as H,dM as u,dv as me,dg as w,dB as B,dJ as U,eq as fe,d$ as F,dd as K,dP as A,dp as M,dE as we,da as E,dX as _,en as oe,dK as be,dD as ce,eA as ge,eB as ye}from"./index-tMLO9JRK.js";import{P as D}from"./index-TOXa0saL.js";import{S as ve}from"./SwapController-Btef5CTI.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
