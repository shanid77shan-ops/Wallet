import{dV as k,ez as le,d9 as c,db as pe,dt as v,du as V,dx as f,dy as g,dz as d,dw as l,dL as $,dk as H,dM as u,dv as me,dg as w,dB as B,dJ as U,eq as fe,d$ as F,dd as K,dP as A,dp as M,dE as we,da as E,dX as _,en as oe,dK as be,dD as ce,eA as ge,eB as ye}from"./index-BfI7-plG.js";import{P as D}from"./index-DLuXQ9ig.js";import{S as ve}from"./SwapController-D0ex4q7w.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
...
`;var q=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let z=class extends g{constructor(){super(),this.unsubscribe=[],this.paymentAsset=D.state.paymentAsset,this.amount=D.state.amount,this.unsubscribe.push(D.subscribeKey("paymentAsset",t=>{this.paymentAsset=t}),D.subscribeKey("amount",t=>{this.amount=t}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){const i=w.getAllRequestedCaipNetworks().find(r=>r.caipNetworkId===this.paymentAsset.network);return d`<wui-flex
    ...
    </wui-flex>`}};z.styles=[Ee];q([l()],z.prototype,"paymentAsset",void 0);q([l()],z.prototype,"amount",void 0);z=q([f("w3m-pay-header")],z);const Pe=v`
  :host {
    height: 60px;
  }
...
`;var Q=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let T=class extends g{constructor(){super(...arguments),this.message="",this.variant="success"}render(){return d`
    ...
    `}templateIcon(){const t={success:"success",error:"error",warning:"warning",info:"default"},i={success:"checkmark",error:"warning",warning:"warningCircle",info:"info"};return this.variant==="loading"?d`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:d`<wui-icon-box
      ...
      icon=${i[this.variant]}
    ></wui-icon-box>`}};T.styles=[V,ze];Q([l()],T.prototype,"message",void 0);Q([l()],T.prototype,"variant",void 0);T=Q([f("wui-snackbar")],T);const Te=we`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
