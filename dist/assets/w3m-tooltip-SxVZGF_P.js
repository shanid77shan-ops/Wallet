import{O as e,it as t,rt as n,st as r,t as i,y as a}from"./ModalController-CB-GFP55.js";import{C as o,b as s,c,g as l,o as u,s as d,v as f}from"./wui-text-DOWykSyR.js";import"./wui-icon-Cz2Odg9S.js";var p=t({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=e({state:p,subscribe(e){return r(p,()=>e(p))},subscribeKey(e,t){return n(p,e,t)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=o`
  :host {
    width: 100%;
    display: block;
  }
