import{aE as k,bv as le,l as c,C as pe,a as v,r as V,b as f,i as g,d,n as l,a8 as $,A as H,a9 as u,e as me,p as w,v as B,a6 as U,b4 as fe,aK as F,E as K,aB as A,y as M,j as we,S as E,aG as z,b1 as oe,a7 as be,h as ce,bw as ge,bx as ye}from"./index-BSSjMjdI.js";import{P as D}from"./index-CnTsgI8z.js";import{S as ve}from"./SwapController-DXJQpyQO.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
