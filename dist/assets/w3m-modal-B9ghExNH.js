import{dU as k,ey as le,d8 as c,da as pe,ds as v,dt as V,dw as f,dx as g,dy as d,dv as l,dK as $,dj as H,dL as u,du as me,df as w,dA as B,dI as U,ep as fe,d_ as F,dc as K,dO as A,dn as M,dD as we,d9 as E,dW as z,em as oe,dJ as be,dC as ce,ez as ge,eA as ye}from"./index-ufmk1742.js";import{P as D}from"./index-CPzwavE3.js";import{S as ve}from"./SwapController-DdAmKaKi.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
...
`;var q=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let _=class extends g{constructor(){super(),this.unsubscribe=[],this.paymentAsset=D.state.paymentAsset,this.amount=D.state.amount,this.unsubscribe.push(D.subscribeKey("paymentAsset",t=>{this.paymentAsset=t}),D.subscribeKey("amount",t=>{this.amount=t}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){const i=w.getAllRequestedCaipNetworks().find(r=>r.caipNetworkId===this.paymentAsset.network);return d`<wui-flex
    ...
    </wui-flex>`}};_.styles=[Ee];q([l()],_.prototype,"paymentAsset",void 0);q([l()],_.prototype,"amount",void 0);_=q([f("w3m-pay-header")],_);const Oe=v`
  :host {
    height: 60px;
  }
