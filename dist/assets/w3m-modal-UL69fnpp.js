import{aQ as k,bH as le,b as c,C as pe,n as v,r as V,t as f,u as g,v as d,q as l,aa as $,A as H,ab as u,o as me,e as w,y as B,a8 as U,bg as fe,aW as F,E as K,aN as A,l as M,F as we,S as E,aS as z,bd as oe,a9 as be,D as ce,bI as ge,bJ as ye}from"./index-DKGmbCfY.js";import{P as D}from"./index-CPpb26hQ.js";import{S as ve}from"./SwapController-DopkI3WF.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
