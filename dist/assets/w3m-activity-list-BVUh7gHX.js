import{B as e,C as t,g as n,j as r,r as i,u as a,y as o,z as s}from"./ModalController-BrSEVdVr.js";import{T as c,b as l,c as u,g as d,l as f,o as p,p as m,s as h,v as g}from"./wui-text-BzY9ZYvk.js";import{t as _}from"./if-defined-1eJj9azs.js";import"./wui-image-C8HfIq3T.js";import"./wui-icon-box-DcOcjm9E.js";import"./wui-link-_kNvpfcO.js";import"./wui-icon-box-D5_rKSPC.js";import"./wui-shimmer-D7CIVUT7.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=d`
  :host > wui-flex {
    display: flex;
